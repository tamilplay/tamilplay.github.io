...
if ($tpl->result['tags_cloud'] === false) {
	...
	$tags = array();
	$list = array();
	$sizes = array( "inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2", "clouds_small", "clouds_medium", "clouds_large", "clouds_xlarge" );
	$min   = 1;
	$max   = 1;
	$range = 1;
